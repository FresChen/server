...
public class ServerServiceImpl implements ServerService {
    ...
    public Server findServer(String ip) {
        return serverMapper.findServer(ip);
    }
    ...
    public int updateName(Server server) {
        serverMapper.updateName(server);
        return 0;
    }
    ...
    public Server findupdate(String ip,Long id) {
        ...
        return serverMapper.findupdate(ip,id);
    }

    @Override
    public Server find(String userName) {
        return serverMapper.find(userName);
    }
    ...
    public List<Server> selectState() {
        return serverMapper.selectState();
    }
}
